<?php
    ...
    $other_html = file_get_html("https://www.birthastro.com/horoscope/2023-horoscope-for-aries");
            ...
            <div class="main_content">
                ...
                <div class="inner_content">
                    ...
                    <div class="personal_horoscope">
                        <div class="personal_details">Show Your <big><b>Yearly</b></big> horoscope, Please Enter Your Name</div>
                        <form action="yearly_persnol_details.php" method="POST" autocomplete="off">
                            <div class="inputbox">
                    ...
                    <div class="all_horoscope">
                        ...
                        <a href="yearly_details_horoscope.php?horoscope=aries">
                        ...
                        <a href="yearly_details_horoscope.php?horoscope=taurus">
                        <div class="single_horoscope">
                            <div class="logo_horoscope">
                        ...
                        <a href="yearly_details_horoscope.php?horoscope=gemini">
                        <div class="single_horoscope">
                            <div class="logo_horoscope">
                        ...
                        <a href="yearly_details_horoscope.php?horoscope=cancer">
                        <div class="single_horoscope">
                            <div class="logo_horoscope">
                        ...
                        <a href="yearly_details_horoscope.php?horoscope=leo">
                        <div class="single_horoscope">
                            <div class="logo_horoscope">
                        ...
                        <a href="yearly_details_horoscope.php?horoscope=virgo">
                        <div class="single_horoscope">
                            <div class="logo_horoscope">
                        ...
                        <a href="yearly_details_horoscope.php?horoscope=libra">
                        <div class="single_horoscope">
                            <div class="logo_horoscope">
                        ...
                        <a href="yearly_details_horoscope.php?horoscope=scorpio">
                        <div class="single_horoscope">
                            <div class="logo_horoscope">
                        ...
                        <a href="yearly_details_horoscope.php?horoscope=sagittarius">
                        <div class="single_horoscope">
                            <div class="logo_horoscope">
                        ...
                        <a href="yearly_details_horoscope.php?horoscope=capricorn">
                        <div class="single_horoscope">
                            <div class="logo_horoscope">
                        ...
                        <a href="yearly_details_horoscope.php?horoscope=aquarius">
                        <div class="single_horoscope">
                            <div class="logo_horoscope">
                        ...
                        <a href="yearly_details_horoscope.php?horoscope=pisces">
                        <div class="single_horoscope">
                            <div class="logo_horoscope">
