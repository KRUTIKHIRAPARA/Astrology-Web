<?php
    ...
    $other_html = file_get_html("https://www.birthastro.com/horoscopes/monthly-horoscope/".$today_horoscope);
    ...
    $today_horoscope_title_six = $html->find("div.parah_aries_horocope h2",5);
    ...
    $today_horoscope_tip = $html->find("div.parah_aries_horocope p",6);
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/monthly_details_horoscope.css">
    </head>
    <body>
                ...
                <div class="inner_content" >
                    ...
                    <div class="single_conetnt_part">
                        ...
                        <div class="single_content_header">
                            <h1>Monthly Horoscope – Astrology Monthly</h1>
                        </div>
                        ...
                        <p class="content_head"><big><b>House :</b></big> <?php echo $today_horoscope_house ?> <br>
                            ...
                            <p class="content_head">
                                ...
                                <h4><?php echo $today_horoscope_title_six ?></h4>
                                <?php echo $today_horoscope_tip ?><br>
                            </p>
